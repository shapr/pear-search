  ...
  outputs = {
      ...
      forAllSystems = function:
        nixpkgs.lib.genAttrs [
          ...
          "aarch64-darwin"
            ...
            pear-search = craneLib.buildPackage (craneCommon
              // {
    ...
    in {
      checks = forAllSystems ({
        ...
        pear-search-clippy = craneLib.cargoClippy (craneCommon
          // {
            inherit cargoArtifacts;
        ...
        # Check formatting
        pear-search-fmt = craneLib.cargoFmt {
          inherit src;
        };

        # Audit dependencies
        pear-search-audit = craneLib.cargoAudit {
      ...
      packages = forAllSystems ({ pear-search, ... }: {
        inherit pear-search;
        default = pear-search;
      });
      ...
      apps = forAllSystems ({system, ...}: {
        pear-search = {
          type = "app";
          program = "${self.packages.${system}.pear-search}/bin/pear-search";
        };
        default = self.apps.${system}.pear-search;
      });
